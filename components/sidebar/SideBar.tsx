...
const SideBar = () => {
  ...
  return (
    <div className={`${!isOpen&&"hidden"} fixed top-0 let-0 z-50 overflow-y-auto  w-[300px] h-screen p-5 text-white bg-[#54473F]`}>
      ...
      <div className="mt-10 space-y-2 ">
        ...
        <div className="flex space-x-2 bg-white px-2 py-0.5 rounded-xl text-[#54473F]">
      ...
      <div className="bg-[#e1d0c6] text-[#54473F] mt-16 mx-auto w-64 h-52 rounded-xl p-4">
        ...
        <div>
        <p className="text-center font-bold">Meet Buddy, Your Pet Care Guide</p>
        <p className="text-center text-sm">Have questions about</p> 
        <p className="text-center text-sm">your pet's health or behaviour</p>
        </div>
        <div className="flex justify-center  mt-2">
            <button className="bg-[#54473F]  py-2 px-7 rounded-xl text-[#e1d0c6]">Ask Buddy Now</button>
        </div>
      </div>
    </div>
  );
